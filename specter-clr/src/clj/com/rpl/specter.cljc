       ...
       (cond
         ...
         (if (contains? locals-set path)
           ...
           `(com.rpl.specter.impl/->VarUse
              ~path
              ~(if-not (instance? System.Type (resolve path)) `(var ~path))
              (quote ~path)))
       ...
       (let [;;this is a hack, but the composition of &env is considered stable for cljs
                  ...
                  get-cache-code (if (= platform :clj)
                                   `(try (i/get-cell ~cache-sym)
                                         (catch #?(:clj ClassCastException :cljr System.InvalidCastException) e#
...
(extend-type #?(:clj clojure.lang.Keyword :cljr clojure.lang.Keyword :cljs cljs.core/Keyword)
  ImplicitNav
  (implicit-nav [this] (n/keypath* this)))

(extend-type #?(:clj clojure.lang.Symbol :cljr clojure.lang.Symbol :cljs cljs.core/Symbol)
  ImplicitNav
  (implicit-nav [this] (n/keypath* this)))

(extend-type #?(:clj String :cljr String :cljs string)
  ImplicitNav
  (implicit-nav [this] (n/keypath* this)))

(extend-type #?(:clj Number :cljr System.ValueType :cljs number)
  ImplicitNav
  (implicit-nav [this] (n/keypath* this)))
...
(extend-type #?(:clj clojure.lang.AFn :cljr clojure.lang.AFn :cljs function)
  ImplicitNav
  (implicit-nav [this] (pred this)))

(extend-type #?(:clj clojure.lang.PersistentHashSet :cljr clojure.lang.PersistentHashSet :cljs cljs.core/PersistentHashSet)
  ImplicitNav
  (implicit-nav [this] (pred this)))

(extend-type #?(:clj java.util.regex.Pattern :cljr System.Text.RegularExpressions.Regex :cljs js/RegExp)
  ImplicitNav
