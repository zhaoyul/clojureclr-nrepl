...
(extend-protocol AllTransformProtocol
  ...
  #?(:clj clojure.lang.MapEntry :cljr clojure.lang.MapEntry)
  #?(:clj
     (all-transform [structure next-fn]
  ...
  #?(:clj clojure.lang.IPersistentVector :cljr clojure.lang.IPersistentVector :cljs cljs.core/PersistentVector)
  (all-transform [structure next-fn]
    (into []
      (comp (map next-fn)
            (filter not-NONE?))
  ...
  #?(:clj String :cljr String :cljs string)
  (all-transform [structure next-fn]
    (apply str (into []
                     (comp (map next-fn)
                           (filter not-NONE?))
  ...
  #?(:clj clojure.lang.PersistentHashSet :cljr clojure.lang.PersistentHashSet :cljs cljs.core/PersistentHashSet)
  (all-transform [structure next-fn]
    (into #{}
      (comp (map next-fn)
            (filter not-NONE?))
  ...
  #?(:clj clojure.lang.PersistentArrayMap :cljr clojure.lang.PersistentArrayMap)
  #?(:bb
     (all-transform [structure next-fn]
       ...
       (let [k-it (.keyIterator structure)
         ...
         (let [none-count (i/get-cell none-cell)
               array (if (not= 0 none-count)
                       (i/array-copy-of array (* 2 (- len none-count)))
                       array
                       )]
  ...
  #?(:clj clojure.lang.PersistentTreeMap :cljr clojure.lang.PersistentTreeMap :cljs cljs.core/PersistentTreeMap)
  (all-transform [structure next-fn]
    (non-transient-map-all-transform structure next-fn (empty structure)))

  #?(:clj clojure.lang.IRecord :cljr clojure.lang.IRecord)
  #?(:clj
     (all-transform [structure next-fn]
  ...
  #?(:clj clojure.lang.PersistentHashMap :cljr clojure.lang.PersistentHashMap :cljs cljs.core/PersistentHashMap)
  (all-transform [structure next-fn]
    (persistent!
      (reduce-kv
        (fn [m k v]
        ...
        (transient
          #?(:clj clojure.lang.PersistentHashMap/EMPTY :cljr clojure.lang.PersistentHashMap/EMPTY :cljs cljs.core.PersistentHashMap.EMPTY))
...
(extend-protocol FastEmpty
  ...
  (fast-empty? [v]
    (= 0 (vec-count v)))
  #?(:clj clojure.lang.ITransientVector :cljr clojure.lang.ITransientVector :cljs cljs.core/TransientVector)
  (fast-empty? [v]
...
(extend-protocol InsertBeforeIndex
  ...
  #?(:clj java.lang.String :cljr String :cljs string)
  (insert-before-idx [aseq idx val]
    (apply str (insert-before-index-list aseq idx val)))

  #?(:clj clojure.lang.LazySeq :cljr clojure.lang.LazySeq :cljs cljs.core/LazySeq)
  (insert-before-idx [aseq idx val]
  ...
  #?(:clj clojure.lang.IPersistentList :cljr clojure.lang.IPersistentList :cljs cljs.core/List)
  (insert-before-idx [aseq idx val]
    (cond (= idx 0)
      (cons val aseq)
